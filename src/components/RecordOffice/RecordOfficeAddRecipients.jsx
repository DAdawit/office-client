...
const RecordOfficeAddRecipients = () => {
  ...
  return (
    <ContainerDev style="custom-mt-20 w-full">
      <div className="flex w-full custom-gapx-20">
        ...
        <div
          className={`flex w-full custom-gapx-5  ${
                    ...
                    {filteredUsers.map((user) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          />
                          <div className="flex custom-gapx-2 items-center flex-1">
        ...
        >
          {selectedUserIds.size > 0 ? (
            <div className="custom-mb-20">
              ...
              <div className="flex flex-col gap-2">
                {getSelectedUsers().map((user) => (
                  <div
                    key={user.id}
                    className="flex items-center custom-gapx-12 custom-py-12 custom-px-12 bg-white border border-neutral-200 rounded-md"
                  >
                    <Checkbox
                      checked={true}
            ...
            <div className="py-8 text-center text-neutral-500 custom-text-12">
...
export default RecordOfficeAddRecipients;
