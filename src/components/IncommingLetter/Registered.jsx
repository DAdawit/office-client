...
const Registered = () => {
      ...
      render: (item) => (
        <ButtonIconOutlinedPrimary
          ...
          onClick={(e) => {
            e.stopPropagation();
            console.log(item);
            navigate(`/dashboard/incoming-letter/edit/${item.id}`);
        ...
        <>
          <ButtonIconFilledPrimary
            ...
            onClick={(e) => {
              e.stopPropagation();
              console.log(item);
              navigate(`/dashboard/incoming-letter/${item.id}`);
  ...
  return (
    <div id="sticky_container">
      <StickyHeader
        className="flex justify-end mt-[14px]"
        id="sticky_container"
      >
        <NavLink to="/dashboard/incoming-letter/register">
          <ButtonPrimaryFilled
            icon={<Plus />}
      ...
      <ContainerDev style="mt-[14px]">
        ...
        />
        {/* <div className="custom-mt-20 custom-p-20 bg-gray-100 rounded">
